              ...
              {portfolios.map((portfolio) => (
                <div key={portfolio.portfolio_id} className="portfolio-card">
                  ...
                  <div className="portfolio-actions">
                    <button className="btn-secondary" onClick={() => navigate(`/portfolio/${portfolio.portfolio_id}`)}>{t('portfolio.viewDetails')}</button>
